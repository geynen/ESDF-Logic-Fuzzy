...
function buscar($idregla)
 ...
 function consultarMembresiasHija($regla)
 {
  $sql = "SELECT distinct C1.descripcion as membresia_input1, C2.descripcion as membresia_input2, C3.descripcion as membresia_output, C3.idmembresia as idmembresia_output FROM REGLAS R INNER JOIN MEMBRESIA C1 ON R.membresia_input1=C1.idmembresia INNER JOIN MEMBRESIA C2 ON R.membresia_input2=C2.idmembresia INNER JOIN MEMBRESIA C3 ON R.membresia_output=C3.idmembresia INNER JOIN VARIABLE_LINGUISTICA V1 ON V1.idvariable=R.variable_input1 INNER JOIN VARIABLE_LINGUISTICA V2 ON V2.idvariable=R.variable_input2 INNER JOIN VARIABLE_LINGUISTICA V3 ON V3.idvariable=R.variable_output WHERE 1=1  ";
   
   if($regla!="")
   {
   $sql=$sql." and C3.descripcion like '%".$regla."%'";
   }
 ...
 function consultarMembresiaPadre($regla)
 {
  $sql = "SELECT distinct C1.descripcion as membresia_input1, C2.descripcion as membresia_input2, C3.descripcion as membresia_output FROM REGLAS R INNER JOIN MEMBRESIA C1 ON R.membresia_input1=C1.idmembresia INNER JOIN MEMBRESIA C2 ON R.membresia_input2=C2.idmembresia INNER JOIN MEMBRESIA C3 ON R.membresia_output=C3.idmembresia INNER JOIN VARIABLE_LINGUISTICA V1 ON V1.idvariable=R.variable_input1 INNER JOIN VARIABLE_LINGUISTICA V2 ON V2.idvariable=R.variable_input2 INNER JOIN VARIABLE_LINGUISTICA V3 ON V3.idvariable=R.variable_output WHERE 1=1  ";
   
   if($regla!="")
   {
   $sql=$sql." and (C1.descripcion like '%".$regla."%' OR C2.descripcion like '%".$regla."%')";
   }
