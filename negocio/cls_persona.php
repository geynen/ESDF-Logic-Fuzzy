...
class clsPersona
{
function insertar($codigo, $apellidopaterno, $apellidomaterno, $nombres, $fechanacimiento, $lugarnacimiento, $sexo, $nrodoc, $direccion, $estadocivil, $telefonofijo, $celular, $email, $tipopersona)
 {
    $sql = "INSERT INTO PERSONA(idpersona, codigo, apellidopaterno, apellidomaterno, nombres, fechanacimiento, lugarnacimiento, sexo, nrodoc, direccion, estadocivil, telefonofijo, celular, email, estado, tipo) VALUES(NULL,'$codigo', upper(trim('$apellidopaterno')), upper(trim('$apellidomaterno')), upper(trim('$nombres')), '$fechanacimiento', '$lugarnacimiento', '$sexo', '$nrodoc', '$direccion', '$estadocivil', '$telefonofijo', '$celular', '$email', 'N', '$tipopersona')";
...
function buscar($idpersona, $apellidosynombres, $tipopersona=NULL)
 {
...
FROM persona P left join Usuario U on U.idpersona=P.idpersona ";
   ...
   if(isset($tipopersona))
	$sql = $sql . " AND P.tipo='".$tipopersona."'";
   if(isset($idpersona))
