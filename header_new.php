    ...
    <div class="art-header">
        <div class="art-header-position">
            <div class="art-header-wrapper">
                ...
                <div class="art-logo">
                                 <h1 class="art-logo-name"><a href="#">Sistema Experto de Diagnostico de Diabetes Militus II</a></h1>
...
<div class="art-nav-outer">
	<ul class="art-hmenu">
		...
		<li>
			<a href="#" class="active">Perfil: <font color='white'><?php echo $_SESSION['TipoUsuario'];?></font></a>
		</li>
