...
$tabla.="<td width='65'><div align='center'><a href='mant_reglas.php?accion=ACTUALIZAR&IdRegla=". $dato->idregla."'><img src='../Imagenes/Editar.GIF' width='58'height='28'border='0'></a></div></td>";
$tabla.="<td width='61'><div align='center'><a href='../negocio/cont_regla.php?accion=ELIMINAR&IdRegla=".$dato->idregla."'><img src='../Imagenes/Elimi.GIF' width='58'height='28'border='0'></a></div></td>";
$tabla.="</tr>";
}
