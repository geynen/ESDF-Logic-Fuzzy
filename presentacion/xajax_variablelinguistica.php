...
$tabla.="<td width='40'><div align='center'><a href='mant_variablelinguistica.php?accion=ACTUALIZAR&IdVariable=". $dato->idvariable."&IdMembresia=".$membresia."'><img src='../Imagenes/Editar.GIF' width='58'height='28'border='0'></a></div></td>";
$tabla.="<td width='40'><div align='center'><a href='../negocio/cont_variablelinguistica.php?accion=ELIMINAR&IdVariable=".$dato->idvariable."&IdMembresia=".$membresia."'><img src='../Imagenes/Elimi.GIF' width='58'height='28'border='0'></a></div></td>";
$tabla.="</tr>";
}
