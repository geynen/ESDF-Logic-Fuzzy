...
<h2 class="art-postheader">REGLA</h2>
...
<table width="925" border="0">
  <tr>
    <td width="34" rowspan="3" class="cabezera"><h1><font color="white">IF</font></h1></td>
    <td width="175" align="right">TIPO CRITERIO</td>
    <td width="219"><?php if($_GET['accion']=='ACTUALIZAR')
	echo genera_cbotipocriterio('Input1',$dato->tipocriterio1); else genera_cbotipocriterio('Input1',0)?></td>
    <td width="62">&nbsp;</td>
    <td width="171" align="right">TIPO CRITERIO </td>
    <td width="238"><?php if($_GET['accion']=='ACTUALIZAR')
echo genera_cbotipocriterio('Input2',$dato->tipocriterio2); else genera_cbotipocriterio('Input2',0)?></td>
  </tr>
  <tr>
    <td align="right">MEBRESIA ENTRADA </td>
    <td><div id="divmembresiaInput1">
    ...
    <td width="171" align="right">MEBRESIA ENTRADA </td>
    <td width="238"><div id="divmembresiaInput2">
  ...
  <tr>
    <td align="right">VARIABLE ENTRADA </td>
    <td><div id="divvariableInput1">
      <select name="cboVariableInput1" id="cboVariableInput1" multiple>
        <option value="0">SELECCIONE UNA MEMBRESIA</option>
      </select>
    </div></td>
    <td>&nbsp;</td>
    <td width="171" align="right">VARIABLE ENTRADA </td>
    <td width="238"><div id="divvariableInput2">
...
<table width="515" border="0" align="center">
  ...
  <tr>
    <td rowspan="3" class="cabezera"><h2><font color="white">THEN</font></h2></td>
    <td align="right">TIPO CRITERIO </td>
...
echo genera_cbotipocriterio('Output',$dato->tipocriterio3); else genera_cbotipocriterio('Output',0)?></td>
  ...
  <tr>
    <td align="right">MEBRESIA SALIDA </td>
    <td><div id="divmembresiaOutput">
  ...
  <tr>
    <td align="right">VARIABLE SALIDA </td>
    <td><div id="divvariableOutput">
  ...
  <tr>
    <td colspan="3" align="center"><center><input type='submit' name = 'grabar' value='GRABAR'>      <input type='button' name = 'cancelar' value='CANCELAR' onClick="javascript:window.open('list_reglas.php','_self')"></center></td>
    </tr>
</table>
</center>
</form>
