...
<table width="925" border="0">
  <tr>
    ...
    <td width="623">
	<div id="headerPanel">
		<h2 class="centrarText">SISTEMA EXPERTO DE SELECCION DE PERSONAL </h2>
...
<tr>
	<td width="238" bgcolor="#E1ECDF"> CODIGO :</td>
	<td width="172" bgcolor="#E1ECDF"><input type='text' name = 'txtCodigo' value = '<?php 
...
<tr>
	<td bgcolor="#E1ECDF"> APELLIDO PATERNO :</td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtApellidoPaterno' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->apellidopaterno;?>' maxlength="50" size="25" style= "text-transform:uppercase">
	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> APELLIDO MATERNO :</td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtApellidoMaterno' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->apellidomaterno;?>' maxlength="50" size="25" style= "text-transform:uppercase">
	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> NOMBRES :</td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtNombres' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->nombres;?>' maxlength="50" size="25" style= "text-transform:uppercase">
	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> N&Uacute;MERO DOCUMENTO : </td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtNroDoc' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR') {
...
<tr>
	<td bgcolor="#E1ECDF"> <div id="DivSexo1">SEXO : </div></td>
	<td bgcolor="#E1ECDF"><div id="DivSexo2">
...
<tr>	
	<td bgcolor="#E1ECDF"> FECHA NACIMIENTO :</td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtFechaNacimiento' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
...
<tr>
	<td bgcolor="#E1ECDF">LUGAR NACIMIENTO :</td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtLugarNacimiento' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->lugarnacimiento;?>' maxlength="50" size="25" style= "text-transform:uppercase">
	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> DIRECCI&Oacute;N : </td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtDireccion' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->direccion;?>' maxlength="50" size="25" style= "text-transform:uppercase">
	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> ESTADO CIVIL : </td>
	<td bgcolor="#E1ECDF"> <select id="cboEstadoCivil" name="cboEstadoCivil">
	<option value="S" <?php 
	if($_GET['accion']=='ACTUALIZAR')
	{ 
...
<tr>
	<td bgcolor="#E1ECDF">TEL&Eacute;FONO FIJO : </td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtTelefonoFijo' value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
...
<tr>
	<td bgcolor="#E1ECDF"> TEL&Eacute;FONO MOVIL : </td>
	<td bgcolor="#E1ECDF"><input type='text' name = 'txtTelefonoMovil' value = '<?php
	if($_GET['accion']=='ACTUALIZAR')
...
<tr>
	<td bgcolor="#E1ECDF"> EMAIL : </td>
	<td bgcolor="#E1ECDF"> <input type='text' name = 'txtEmail' maxlength="50" size="25" value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->email;?>'>
	</td>
</tr>
...
<tr>
	<td width="237" bgcolor="#E1ECDF"> LOGIN : </td>
	<td width="178" bgcolor="#E1ECDF"><input name = 'txtUsuario' type='text' id="txtUsuario" value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->usuario;?>' size="25" maxlength="50">	</td>
</tr>
<tr>
	<td bgcolor="#E1ECDF"> CLAVE : </td>
	<td bgcolor="#E1ECDF"><input name = 'txtClave' type='password' id="txtClave" value = '<?php 
	if($_GET['accion']=='ACTUALIZAR')
	echo $dato->usuario;?>' size="25" maxlength="50">	</td>
</tr>
<tr>
